...
<div class="panel panel-default">
    <div class="panel-heading">Update Feed Customer</div>
    <div class="panel-body">
        @if (Session::has('message'))
            <div class="alert alert-info">{{ Session::get('message') }}</div>
        @endif
        {!! Form::model($customer,['method'=>'PATCH', 'action'=>['FeedCustomerController@update', $customer], 'files'=>true]) !!}
            ...
            <div class="col-md-2 form-group">
                {!! Form::submit('Update Feed Customer', array('class'=> 'btn btn-primary complete-btn')) !!}
            </div>
        {!! Form::close() !!}
    </div>
</div>
