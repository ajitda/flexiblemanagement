...
@section("content")
    ...
    <div class="panel panel-default" ng-app="purchaseApp" >
        ...
        <div class="panel-body" ng-controller="purchaseController">
            ...
            @endif
            {!! Form::model($purchase, ['method'=>'PATCH', 'action'=>['ChickPurchaseController@update', $purchase], 'files'=>true]) !!}
            ...
            <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-2">
                    ...
                    {!! Form::number('less', null, array('required', 'id'=> 'less', 'class' => 'form-control', 'ng-model'=>'less', 'ng-init'=>"less='$purchase->less'")) !!}
                </div>
            <div class="form-group col-md-2">
                <label for="payment">Payment : </label>
                {!! Form::number('payment', null, array('required', 'id'=> 'payment', 'class' => 'form-control', 'ng-model'=>'payment', 'ng-init'=>"payment='$purchase->payment'")) !!}
            </div>
            <div class="form-group col-md-2">
