...
<div class="panel panel-default" ng-app="purchaseApp">
    ...
    <div class="form-group col-md-3">
        ...
        {!! Form::number('qty', null, array('required', 'id'=> 'qty', 'class' => 'form-control', 'ng-model'=>'exqty')) !!}
    </div>
    <div class="form-group col-md-3">
        <label for="unit_expense" >Unit Expense : </label>
        {!! Form::number('unit_expense', null, array('required', 'step' => 'any', 'id'=> 'unit_expense', 'class' => 'form-control', 'ng-model'=>'unitExpense')) !!}
    </div>
    <div class="form-group col-md-2">
        ...
        <div class="col-md-2 form-group">
            {!! Form::submit('Add Expense', array('class'=> 'btn btn-primary complete-btn')) !!}
        </div>
    {!! Form::close() !!}
    </div>
</div>
