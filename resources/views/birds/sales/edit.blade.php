...
@section("content")
    ...
    <div class="panel panel-default" ng-app="purchaseApp">
        ...
        <div class="panel-body" ng-controller="purchaseController">
            ...
            @endif
            {!! Form::model($sale,  ['method'=>'PATCH', 'action'=>['SaleController@update', $sale], 'files'=>true]) !!}
                ...
                <div class="form-group col-md-2">
                    ...
                    {!! Form::number('weight', null, array('required', 'step' => 'any', 'id'=> 'weight', 'class' => 'form-control', 'ng-model'=>'weight','ng-init'=>"weight='$sale->weight'")) !!}
                </div>
                <div class="form-group col-md-2">
                    <label for="tweight" >Total Weight (Kg ) : </label>
                    {!! Form::number('tweight', null, array('required', 'step' => 'any', 'id'=> 'tweight', 'class' => 'form-control', 'ng-model'=>'tweight','ng-init'=>"tweight='$sale->tweight'")) !!}
                </div>
                <div class="form-group col-md-2">
                    <label for="price_per_kg">Price Per Kg (Tk.): </label>
                    {!! Form::number('price_per_kg', null, array('required', 'step' => 'any','id'=> 'price_per_kg', 'class' => 'form-control', 'ng-model'=>'price_per_kg','ng-init'=>"price_per_kg='$sale->price_per_kg'")) !!}
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-2">
                    ...
                    {!! Form::number('death_qty', null, array('required', 'id'=> 'death_qty', 'class' => 'form-control', 'ng-model'=>'death_qty', 'ng-init'=>"death_qty='$sale->death_qty'")) !!}
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-2">
                    ...
                    {!! Form::number('less', null, array('required', 'id'=> 'less', 'step'=>'any', 'class' => 'form-control', 'ng-model'=>'less', 'ng-init'=>"less='$sale->less'")) !!}
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="sub_total_text"><span data-ng-bind="tweight * price_per_kg - payment - less | currency"></span></div>
                </div>
                <div class="clearfix"></div>
