            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4">
                            <h4><strong>Total Purchased : <span class="navy">Tk.<?php echo e(number_format(DB::table('chick_purchases')->where('chick_supplier_id', $supplier->id)->sum('payment'), 2)); ?></span></strong></h4>
                        </div>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $supplier->chick_purchase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
