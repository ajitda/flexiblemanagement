<?php $__env->startSection("content"); ?>
    ...
    <div class="panel panel-default" ng-app="purchaseApp">
        ...
        <div class="panel-body" ng-controller="purchaseController">
            ...
            <?php endif; ?>
            <?php echo Form::model($sale,  ['method'=>'PATCH', 'action'=>['FeedSaleController@update', $sale], 'files'=>true]); ?>
                ...
                <div class="col-md-2 form-group">
                    ...
                    <?php echo Form::submit('Update Feed Sale', array('class'=> 'btn btn-primary complete-btn')); ?>
