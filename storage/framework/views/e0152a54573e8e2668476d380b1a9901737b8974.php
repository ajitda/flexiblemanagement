...
<div class="panel panel-default" ng-app="purchaseApp">
    ...
    <div class="panel-body" ng-controller="purchaseController">
        <?php echo Form::open(['route'=>'purchases.store', 'files'=>true]); ?>
            ...
            <div class="form-group col-md-2">
                ...
                <?php echo Form::number('transport', null, array('required', 'id'=> 'transport', 'class' => 'form-control', 'ng-model'=>'transport')); ?>

            </div>
            <div class="form-group col-md-2">
                <label for="daily_stuff_salary">Daily Stuff Salary : </label>
                <?php echo Form::number('daily_stuff_salary', null, array('required', 'id'=> 'daily_stuff_salary', 'class' => 'form-control', 'ng-model'=>'daily_stuff_salary')); ?>

            </div>
            <div class="form-group col-md-2">
                <label for="others">Others (Tk.) : </label>
                <?php echo Form::number('others', null, array('required', 'id'=> 'others', 'class' => 'form-control', 'ng-model'=>'others')); ?>
            ...
            <div class="form-group col-md-2">
                ...
                <?php echo Form::number('less', null, array('required', 'step'=>'any', 'class'=>'form-control', 'ng-model'=>'less')); ?>
