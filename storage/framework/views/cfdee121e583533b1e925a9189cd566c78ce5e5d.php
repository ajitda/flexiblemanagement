<?php $__env->startSection("content"); ?>
    ...
    <div class="panel panel-default" ng-app="purchaseApp">
        ...
        <div class="panel-body" ng-controller="purchaseController">
            <?php echo Form::model($expense,  ['method'=>'PATCH', 'action'=>['ExpenseController@update', $expense], 'files'=>true]); ?>
            ...
            <div class="form-group col-md-3">
                ...
                <?php echo Form::number('qty', null, array('required', 'id'=> 'qty', 'class' => 'form-control', 'ng-model'=>'exqty', 'ng-init'=>"exqty='$expense->qty'")); ?>

            </div>
            <div class="form-group col-md-3">
                <label for="unit_expense" >Unit Expense : </label>
                <?php echo Form::number('unit_expense', null, array('required', 'step' => 'any', 'id'=> 'unit_expense', 'class' => 'form-control', 'ng-model'=>'unitExpense','ng-init'=>"unitExpense='$expense->unit_expense'")); ?>
            ...
            <div class="col-md-2 form-group">
                <?php echo Form::submit('Update Expense', array('class'=> 'btn btn-primary complete-btn')); ?>
