<?php $__env->startSection("content"); ?>
    ...
    <div class="panel panel-default" ng-app="purchaseApp" >
        ...
        <div class="panel-body" ng-controller="purchaseController">
            ...
            <?php endif; ?>
            <?php echo Form::model($purchase, ['method'=>'PATCH', 'action'=>['FeedPurchaseController@update', $purchase], 'files'=>true]); ?>
                ...
                <div class="form-group col-md-2">
                    ...
                    <?php echo Form::number('less', null, array('required', 'id'=> 'less','step'=>'any', 'class' => 'form-control', 'ng-model'=>'less', 'ng-init'=>"less='$purchase->less'")); ?>

                </div>
                <div class="form-group col-md-2">
                    <label for="payment">Payment : </label>
                    <?php echo Form::number('payment', null, array('required', 'step'=>'any', 'class'=>'form-control', 'ng-model'=> 'payment', 'ng-init'=>"payment='$purchase->payment'")); ?>
                ...
                <div class="col-md-2 form-group">
                    <?php echo Form::submit('Feed Purchase Update', array('class'=> 'btn btn-primary complete-btn')); ?>
