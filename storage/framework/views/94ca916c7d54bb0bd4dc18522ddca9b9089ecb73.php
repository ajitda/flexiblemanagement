                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href="feedsuppliers/<?php echo e($supplier->id); ?>"><?php echo e($supplier->supplier_name); ?></a></td>
                                    ...
                                    <td>
                                        <a href="feedsuppliers/<?php echo e($supplier->id); ?>/edit"><span class="glyphicon glyphicon-edit"></span></a>
                                    </td>
                                    <?php if($user == 'admin'): ?>
                                    <td><a href="#" onclick="return confirm('are you sure?')">
                                        <?php echo Form::open(['method'=> 'DELETE', 'route'=>['feedsuppliers.destroy', $supplier->id]]); ?>
