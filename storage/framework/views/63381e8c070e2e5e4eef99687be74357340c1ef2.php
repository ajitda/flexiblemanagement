                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row sales_heading">
                            <div class="col-md-2 col-print-12">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4 col-print-12">
                            ...
                            <h4><strong>Total Sales : <span class="navy">Tk.<?php echo e(number_format(DB::table('chick_sales')->where('chick_customer_id', $customer->id)->sum('total') + $customer->balance, 2)); ?></span></strong></h4>
                            <h4><strong>Total Payment : <span class="navy">Tk.<?php echo e(number_format(DB::table('chick_sales')->where('chick_customer_id', $customer->id)->sum('payment') + $customer->payment, 2)); ?></span></strong></h4>
                            <h4><strong>Balnce/Dues : <span class="red">Tk.<?php echo e(round(DB::table('chick_sales')->where('chick_customer_id', $customer->id)->sum('total') + $customer->balance -DB::table('chick_sales')->where('chick_customer_id', $customer->id)->sum('payment') - $customer->payment, 2)); ?></span></strong></h4>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-hover" >
                                ...
                                <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="hidden-print"><?php echo e($sale->chick_supplier->supplier_name); ?></td>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        ...
        function listSales(criteria1, criteria2, criteria3)
        {
            $.ajax({
                type : 'get',
                url : "<?php echo url('/chicks/customers/getsales'); ?>",
