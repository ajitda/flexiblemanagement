...
<div class="panel panel-default" ng-app="purchaseApp">
    ...
    <div class="panel-body" ng-controller="purchaseController">
        <?php echo Form::open(['route'=>'feedpurchases.store', 'files'=>true]); ?>
            ...
            <div class="form-group col-md-2">
                ...
                <?php echo Form::number('payment', null, array('required', 'class'=>'form-control', 'id'=>'payment', 'ng-model'=> 'payment')); ?>
            ...
            <div class="col-md-2 form-group">
                <?php echo Form::submit('Complete Feed Purchase', array('class'=> 'btn btn-primary complete-btn')); ?>
